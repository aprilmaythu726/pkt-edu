...
<?php include(dirname(__FILE__) ."/../templates/header.php"); ?>
  ...
  <div class="row page-tilte align-items-center">
    <div class="col-md-auto">
      ...
      <h1 class="weight-300 h3 title">Activity Management</h1>
    </div> 
    <div class="col controls-wrapper mt-3 mt-md-0 d-none d-md-block ">
      <div class="controls d-flex justify-content-center justify-content-md-end float-right">
      
      <a href="<?php echo base_url('adm/portal/news/add'); ?>" class="btn btn-secondary py-1 px-2" ><span class="material-icons align-text-bottom">add_circle</span></a>      
      </div>
    </div>
  </div> 
        ...
        <tr>
          ...
          <td>
            ...
            <a href="<?php echo base_url($row->thumb) ?>" data-gallery="example-gallery" data-toggle="lightbox">
              <img src="<?php echo base_url($row->thumb) ?>" width="60" class="img-thumbnail bg-white img-fluid mb-4">
            </a>
            </div>
          </td>          
          <td class="text-left">
            <a href="<?php echo base_url('adm/portal/news/view/'.$row->id); ?>">
              <?php echo $row->title; ?>
            </a>
          </td>
          ...
          <td class="text-center">
            ...
            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="actionDropdown">
              <a class="dropdown-item" href="<?php echo base_url('adm/portal/news/edit/'.$row->id); ?>">Edit</a>
              <a onclick="return confirm('Are you want to delete this data?');"  class="dropdown-item" href="<?php echo base_url('adm/portal/news/delete/'.$row->id); ?>">Delete</a>
            </div>
          </td>
        </tr>
        <?php $x++; } ?>
