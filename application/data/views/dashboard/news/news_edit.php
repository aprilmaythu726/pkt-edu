...
<div class="content-wrapper">
	<div class="row page-tilte align-items-center">
		<div class="col-md-auto">
			...
			<h1 class="weight-300 h3 title">Edit News</h1>
		</div>
      ...
      <div class="col-lg-12 col-md-12 mb-4 mb-lg-0">
        <div class="card">
          ...
          <?php
            ...
            echo form_open_multipart('adm/portal/news/edit/'.$result->id, $attributes);
          ?>
          ...
          <div class="col-lg-12 col-md-12 float-left">
            ...
            <div class="form-group">
              ...
              <textarea name="content" cols="" rows="10" placeholder="Enter description" class="form-control">
            ...
            if(isset($result->photo)){
              echo '<img src="'.base_url().'upload/assets/adm/new/'.$result->photo.'" style="width:250px;">';
            } ?>
              <div class="form-group">
