  ...
  <div class="row page-tilte align-items-center">
    <div class="col-md-auto">
      <a href="#" class="mt-3 d-md-none float-right toggle-controls"><span class="material-icons">keyboard_arrow_down</span></a>
        <h1 class="weight-300 h3 title">Categories Management</h1>
    </div> 
        ...
        <tr>
          ...
          <td class="text-center"><a href="#" class="text-muted" id="actionDropdown" data-toggle="dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="actionDropdown">
              <a class="dropdown-item" href="<?php echo base_url('adm/portal/category/edit/'.$row->id); ?>">Edit</a>
              <a onclick="return confirm('Are you want to delete this data?');" class="dropdown-item" href="<?php echo base_url('adm/portal/category/delete/'.$row->id); ?>">Delete</a>
            </div>
          </td>
        </tr>
        <?php } ?>
        ...
        <div class="modal-dialog col-11 p-0" role="document">
          <div class="modal-content">
            <?php
              ...
              echo form_open('adm/portal/category/add', $attributes);
            ?>
            ...
            <div class="modal-body p-4">
              <div class="form-group">
                <?php
                  echo form_label('Category name','name', array('class' => ''));
