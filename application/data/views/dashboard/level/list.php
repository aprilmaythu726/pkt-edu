...
<?php include(dirname(__FILE__) ."/../templates/header.php"); ?>
  ...
  <div class="row page-tilte align-items-center">
    <div class="col-md-auto">
      ...
      <h1 class="weight-300 h3 title">Level Management</h1>
    </div> 
        ...
        <tr>
          ...
          <td class="text-center"><a href="#" class="text-muted" id="actionDropdown" data-toggle="dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="actionDropdown">
              <a class="dropdown-item" href="<?php echo base_url('adm/portal/level/edit/'.$row->id); ?>">Edit</a>
              <a onclick="return confirm('Are you want to delete this data?');" class="dropdown-item" href="<?php echo base_url('adm/portal/level/delete/'.$row->id); ?>">Delete</a>
            </div>
          </td>
        </tr>
        <?php } ?>
        ...
        <div class="modal-dialog col-11 p-0" role="document">
          <div class="modal-content">
            <?php
              ...
              echo form_open('adm/portal/level/add', $attributes);
            ?>
