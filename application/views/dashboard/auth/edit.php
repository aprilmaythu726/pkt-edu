      ...
      <div class="col-lg-12 col-md-12 mb-4 mb-lg-0">
        <div class="card">
          ...
          <?php
            ...
            echo form_open('adm/portal/auth/edit/'.$result->id, $attributes);
          ?>
            <div class="col-lg-6 col-md-6 float-left">
              ...
              <div class="form-group">
                ...
                echo form_dropdown(
                    'role',  //dropdown name
                    $rolelist,
                    set_value('role',isset($result)?$result->role_:''),
                    $setarray
                );
                ?>
              ...
              <div class="form-group">
                ...
                <?php
                  echo form_input(array(
                    'name' => 'admin_phone',
                    'type' => 'text',
                    'value' => html_escape(set_value('admin_phone',isset($result)?$result->phone_:''), ENT_QUOTES),
