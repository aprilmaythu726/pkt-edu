...
<div class="content-wrapper">
  <div class="row page-tilte align-items-center">
    <div class="col-md-auto">
      <h1 class="weight-300 h3 title">Admin User Detail</h1>
    </div> 
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="text-center mt-4">
                    ...
                    <a href="<?php echo base_url('adm/portal/auth/edit/'.$result->id); ?>" class="btn btn-sm btn-secondary text-light" data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit Information"><span class="material-icons align-middle">edit</span></a>
                    <a href="<?php echo base_url('adm/portal/auth/withdraw/'.$result->id); ?>" onclick="return confirm('Are you want to delete this data?');" class="btn btn-sm btn-secondary text-light" data-toggle="tooltip" data-placement="top" title="" data-original-title="Delete User"><span class="material-icons align-middle">delete</span></a>
                </div>
                ...
                <div class="tab-content" id="myTabContent">
                    <div class="tab-pane fade show active" id="profile" usr_role="tabpanel" aria-labelledby="profile-tab">
                        ...
                        <p>
                            ...
                            <span class="text-dark weight-400"><?php echo $result->phone; ?></span>
                        </p>
                        <p>
                            <span>Address : </span>
                    ...
                    <div class="tab-pane fade" id="site" usr_role="tabpanel" aria-labelledby="site-tab">
                      ...
                      ?>
                        ...
                        <p>
                            ...
                            <span class="text-dark weight-400"><?php echo $config->user_session/60; ?> Minutes</span>
                        </p>
                    ...
                    <div class="tab-pane fade" id="logs" usr_role="tabpanel" aria-labelledby="logs-tab">
                        <div class="">
                            ...
                            <hr class="my-2 dashed">
                            <div class="text-right">
                                <a href="<?php echo base_url('force/logout/'.$result->id); ?>" class="btn btn-sm btn-secondary text-light" data-toggle="tooltip" data-placement="top" title="" data-original-title=""><span class="material-icons align-middle">autorenew</span></a>
                            </div>
