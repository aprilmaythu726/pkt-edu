...
<div class="content-wrapper">
    ...
    <div class="col-md-auto">
      ...
      <h1 class="weight-300 h3 title">Add Instructor</h1>
    </div>
  ...
  <div class="content">
    <div class="row">
        ...
        <?php
          ...
          echo form_open_multipart('adm/portal/instructor/add', $attributes);
        ?>
            ...
            <div class="form-group">
                ...
                echo form_input(array(
                    'name' => 'tra_phone',
                    'type' => 'text',
                    'value' => html_escape(set_value('tra_phone',isset($result)?$result->phone:''), ENT_QUOTES),
            ...
            <div class="form-group">
                ...
                <div class="radio">
                    <label class="col-md-2">
                        <input type="radio" name="tra_status" value="1" > Public
                    </label>
                    <label class="col-md-2">
                        <input type="radio" name="tra_status" value="0" checked="checked"> Privated
                    </label>
                </div>
            </div>
